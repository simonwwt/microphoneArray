...
function H = secondOrderSupercardioid(d, f)
...
st_vec2 = getSteeringVector(4, d, w, pi/1.18);
st_vec3 = getSteeringVector(4, d, w, pi/1.69);
constraint_vec = [0 1 0 -1];
A = [st_vec1'; st_vec2'; st_vec3'; constraint_vec];
B = [1 0 0 0];
B = B';
% Designed filter
H = A\B;
